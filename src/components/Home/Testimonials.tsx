                ...
                <Card className="bg-gray-500 border-none shadow-md hover:shadow-lg transition-shadow w-full h-64 mx-auto flex flex-col justify-between">
                  <CardContent className="p-6 flex flex-col h-full">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-left text-white">{testimonial.name}</h3>
                        <p className="text-white text-left text-sm text-muted-foreground">
                          {testimonial.role}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 flex flex-col justify-between flex-grow">
                      ...
                      <p className="text-white text-sm text-muted-foreground leading-relaxed flex-grow">
